...
let slider_stategies = new Swiper('.strategies__body', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// Dotts
	pagination: {
		el: '.strategies__slider-paggination',
		clickable: true,
	},
	// Arrows
	navigation: {
...
let slider_reviews = new Swiper('.reviews__columns', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
...
if (iconMenu != null && headerWrapper != null) {
	let delay = 500;
...
const priceColumn = document.querySelectorAll('.price-column__column-content');
const priceColumns = document.querySelector('.price__columns');
if (priceColumn != null) {
	for (let index = 0; index < priceColumn.length; index++) {
		const column = priceColumn[index];
		column.addEventListener('mouseover', (e)=>{
			for (let index = 0; index < priceColumn.length; index++) {
				const element = priceColumn[index];
		...
		column.addEventListener('mouseleave', (e)=>{
			...
			for (let index = 0; index < priceColumn.length; index++) {
				...
				if(element.classList.contains('checked')){
					let checkedElem= element;
					checkedElem.classList.add('_active');
				}
			}
		});
	}
...
//===================================================================================================================================
const switcherBtn = document.querySelector('.header__switcher');

function chagneThemeClass(themeMode){
	if(themeMode === 'dark'){
...
chagneThemeClass('light');
chagneThemeClass(localStorage.getItem('theme'));

if(localStorage.getItem('theme') === 'dark'){
	switcherBtn.classList.add('_dark')
}else{
	switcherBtn.classList.add('_light');
}
...
switcherBtn.addEventListener('click', (e) => {
	...
	//===================================================================================================================================
	if(localStorage.getItem('theme') === 'dark'){
		switcherBtn.classList.add('_active-theme');
		switcherBtn.classList.add('_dark');
		switcherBtn.classList.remove('_light')
		switcherBtn.classList.remove('_no-active-theme');
	}else{
		switcherBtn.classList.remove('_active-theme');
		switcherBtn.classList.add('_light');
		switcherBtn.classList.remove('_dark');
		switcherBtn.classList.add('_no-active-theme');
	}
	chagneThemeClass(localStorage.getItem('theme'));
	//===================================================================================================================================
});
